                ...
                <div className="w-full">
                    ...
                    <div className="w-full flex justify-center items-center my-10 p-2 flex-col">
                        <div className="grid grid-cols-2 w-[70%] p-2 gap-5 place-items-center">
                            <p className="bg-gray-600 w-96 py-2 px-5 text-center text-white" onClick={() => handleAnswer(currentQuizNumber?.option_A)}>A. {currentQuizNumber?.option_A}</p>
                            <p className="bg-gray-600 w-96 py-2 px-5 text-center text-white" onClick={() => handleAnswer(currentQuizNumber?.option_B)}>B. {currentQuizNumber?.option_B}</p>
                            <p className="bg-gray-600 w-96 py-2 px-5 text-center text-white" onClick={() => handleAnswer(currentQuizNumber?.option_C)}>C. {currentQuizNumber?.option_C}</p>
                            {
                                currentQuizNumber?.option_D == " " ? <p className="bg-gray-600 w-96 py-2 px-5 text-center text-white" onClick={() => handleAnswer(currentQuizNumber?.option_D)}>D. {currentQuizNumber?.option_D}</p> : null
                            }
                        </div>
