...
const Dashboard = () => {
  ...
  return (
    <div>
      <Header />
      <div className="font-semibold bg-[#F9F7FF]">
        ...
        <div className="flex justify-around items-center p-5 gap-2">
          <div>
            <img src="/Banners/Wallpaper-1.jpeg" alt="" className="w-[700px] h-[594px] object-cover" />
          </div>
          <div className="flex justify-center items-start flex-col gap-10 w-[52%] p-2">
            <h1 className="text-[#0C0531] text-4xl w-full">Introduction to Facilities Management</h1>
        ...
        <div className="flex justify-center items-center p-10 flex-col gap-5 bg-[#FFE0F1]">
          <div className="flex flex-col gap-5 p-2 w-[45%] justify-center items-center">
            <h1 className="text-[#0C0531] text-4xl w-full text-center">Why Advaya ?</h1>
            <p>
        ...
        <div className="flex justify-around items-center p-10">
          <div className="flex flex-col gap-5 p-2 w-[45%]">
            <h1 className="text-[#0C0531] text-4xl w-full">FM Upskilling Initiative</h1>
          ...
          <div>
            <img src="/Banners/Library_banner.jpeg" alt="" className="w-[700px] h-[594px]" />
          </div>
        </div>
        ...
        <div className="flex justify-center items-center p-10 flex-col bg-[#F4F4F4] gap-5">
          ...
          <div className="flex justify-around items-center p-2 w-[80%] gap-10">
            <div>
              <img src="/Banners/Library_banner.jpeg" alt="" className="w-[700px] h-[594px]" />
            </div>
            <div className="flex flex-col gap-5 p-2 w-[45%]">
        ...
        <div className="flex justify-center items-center gap-2 p-2">
          <div className="flex flex-col gap-5 p-2 w-[38%]">
            <h1 className="text-[#0C0531] text-4xl w-full">FM Upskilling Initiative</h1>
          ...
          <div>
            <img src="/Banners/Wallpaper-2.jpeg" alt="" className="w-[700px] h-[594px] object-cover" />
          </div>
        </div>

        <div className="bg-[#FFF3FA] flex justify-center items-center gap-10 p-2 py-10">
          <div className="w-[50%] flex justify-center items-center gap-2 flex-col">
            <h1 className="text-[#0C0531] text-4xl w-full text-center p-2">Progressive Based Learning</h1>
        ...
        <div className="flex justify-around items-center gap-5 p-5">
          <div className="flex flex-col gap-5 p-2 w-[36%]">
            <h1 className="text-[#0C0531] text-4xl w-full text-center p-2">Advaya FM LMS App</h1>
        ...
        <div className="flex justify-around items-center gap-5 p-5 mt-5">
          <div className="flex flex-col gap-5 p-2 w-[36%]">
            <div className="flex flex-col gap-3">
              <h1 className="text-xl text-[#B32073]">For Security Business</h1>
          ...
          <div>
            <img src="https://img.freepik.com/premium-vector/security-design_24877-33502.jpg?w=740" alt="" className="w-[700px] h-[594px] object-cover" />
          </div>
        </div>
        ...
        <div>
          <div className="relative shadow-xl font-semibold">
            ...
            <div className="justify-center items-center flex absolute top-48 left-[330px] gap-5 w-[62%] flex-col">
              <h1 className="text-4xl font-bold text-[#0C0531]">Future Expansion Plans</h1>
        ...
        <div className="flex justify-center items-center gap-2 h-96">
          <div className="flex justify-center items-center flex-col w-[70%] gap-5">
            <h1 className="text-4xl font-bold text-[#0C0531]">Conclusion</h1>
        ...
        <div className="flex justify-center items-center gap-2 h-96 bg-[#FFEDF7]">
          <div className="flex justify-center items-center flex-col w-[40%] gap-5">
            <h1 className="text-4xl font-bold text-[#0C0531]">Interested ?</h1>
        ...
        <div className="h-44 relative flex justify-center items-center">
          <div className="absolute flex gap-10 p-10 shadow-xl border-2 top-28 bg-white rounded-lg w-[50%] justify-around items-center">
            <p className="border-e-2 border-black px-10">guru@advayafm.com</p>
            <p>90002 - 01232</p>
          </div>
        </div>
      </div>
